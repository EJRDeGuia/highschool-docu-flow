  ...
  return <Card>
      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-4">
          {showQrCode && <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            <div className="flex items-center gap-3">
              <Input id="receipt" type="file" accept="image/*" onChange={handleFileChange} disabled={isUploading || uploadComplete} className="cursor-pointer" />
            </div>
          </div>
          ...
          {preview && <div className="mt-4">
              ...
              <div className="mt-2 border border-gray-200 rounded-md overflow-hidden">
                <img src={preview} alt="Receipt preview" className="w-full h-auto max-h-[300px] object-contain bg-gray-50" />
              </div>
            </div>}
          
          {uploadComplete && <div className="bg-green-50 border border-green-100 rounded-md p-4 flex items-center gap-3">
        ...
        <CardFooter className="flex flex-col gap-2 sm:flex-row sm:justify-between">
          <Button type="button" variant="outline" className="w-full sm:w-auto" onClick={() => navigate("/dashboard/my-requests")}>
            Cancel
          </Button>
          <Button type="submit" className="w-full sm:w-auto" disabled={!file || isUploading || uploadComplete}>
            {isUploading ? <>

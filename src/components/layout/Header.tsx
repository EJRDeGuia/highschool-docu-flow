...
const Header = ({
  ...
  return <header className="bg-white border-b border-gray-100 py-4 px-5 sticky top-0 z-30 flex items-center justify-between gap-4 shadow-sm">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" onClick={toggleSidebar} className="md:hidden text-gray-700 hover:bg-gray-100">

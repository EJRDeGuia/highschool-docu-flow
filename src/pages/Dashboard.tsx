          ...
          <div className="mt-10">
            <Card className="dashboard-card overflow-hidden border-0 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-school-primary to-school-secondary text-white p-6">
                ...
                <CardDescription className="text-white/90 mt-1">Things you might want to do</CardDescription>
              </CardHeader>
...
const DashboardCard = ({ title, description, value, icon, color, gradient }: DashboardCardProps) => {
  return (
    <Card className="dashboard-card overflow-hidden border-0 shadow-md hover:shadow-lg transition-all duration-300">
...
const ActionCard = ({ title, description, link, icon }: ActionCardProps) => {
  return (
    <a 
      href={link}
      className="group block p-5 rounded-lg border border-gray-100 hover:bg-gray-50 transition-all duration-200 hover:shadow-md"
    >
...
const ActivityItem = ({ title, description, time, status }: ActivityItemProps) => {
  return (
    <div className="flex items-start justify-between p-4 rounded-lg hover:bg-gray-50 transition-colors border border-gray-100">
      <div>
